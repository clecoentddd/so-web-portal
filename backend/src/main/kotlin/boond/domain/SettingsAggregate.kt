...
class SettingsAggregate private constructor() {
        ...
        fun handle(command: UpdateInvoiceStateMappingCommand) {
                logger.info(
                        "UpdateInvoiceStateMappingCommand received for SettingsAggregate $settingsId"
                )
        ...
        fun handle(
                command:
                        boond.domain.commands.fetchcompanieslistfromboond.RequestCompanyListUpdateCommand
        ) {
                logger.info(
                        "RequestCompanyListUpdateCommand received for SettingsAggregate $settingsId"
                )
                AggregateLifecycle.apply(
                        CompanyListUpdateRequestedEvent(
                                settingsId = settingsId,
        ...
        fun on(event: InvoiceStateMappingRequestedEvent) {
                state = "INCOMPLETE"
                logger.info(
                        "InvoiceStateMappingRequestedEvent applied for SettingsAggregate $settingsId"
                )
        }
        ...
        fun on(event: InvoiceStateMappingUpdateRequestedEvent) {
                state = "INCOMPLETE"
                logger.info(
                        "InvoiceStateMappingUpdateRequestedEvent applied for SettingsAggregate $settingsId"
                )
        }
        ...
        fun on(event: CompanyListUpdateRequestedEvent) {
                state = "INCOMPLETE"
                logger.info(
                        "CompanyListUpdateRequestedEvent applied for SettingsAggregate $settingsId"
                )
        }
}
